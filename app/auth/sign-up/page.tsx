...
import { signUpAction, signInWithGoogleAction } from "./action"
    ...
    <div className="min-h-screen bg-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border-2 border-black p-8">
          ...
          {error && (
            <div className="bg-red-100 border-2 border-red-800 text-red-900 px-4 py-3 mb-4 font-sans text-sm">
              {error}
            </div>
          )}
          ...
          <button
            ...
            className="w-full bg-white text-black font-sans font-semibold py-2.5 border-2 border-black hover:bg-gray-50 disabled:opacity-50 transition flex items-center justify-center gap-3 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-gray-600 font-sans uppercase tracking-wider font-semibold">
                Or
              </span>
            </div>
          </div>
